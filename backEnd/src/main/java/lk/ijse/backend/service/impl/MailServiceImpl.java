...
public class MailServiceImpl implements MailService {
    ...
    <head>
        <style>
            ...
            .container { background-color: #1e1e1e; border-radius: 8px; padding: 20px; border-left: 5px solid #ff4d4d; }
    ...
    <head>
        <style>
            ...
            .container { background-color: #1e1e1e; border-radius: 10px; padding: 30px; max-width: 600px; margin: auto; border-left: 5px solid #ff4d4d; }
            h2 { color: #ff4d4d; }
